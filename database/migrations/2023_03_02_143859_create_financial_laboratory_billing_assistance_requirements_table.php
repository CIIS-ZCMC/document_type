...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('financial_laboratory_billing_assistance_requirements', function (Blueprint $table) {
            $table->id();
            $table->string('name');
    ...
    {
        Schema::dropIfExists('financial_laboratory_billing_assistance_requirements');
    }
};
