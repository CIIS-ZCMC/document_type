...
<body>
	<section>
		<div class="wrapper">
			...
			<form class="form" id="form" enctype="multipart/form-data" method="post" action="/createcitizen" >
				@csrf
				<div class="form_wrap">
						...
						<p>Please enter your infomation and proceed to the next step so we can process your identiication card.  </p>
							<div class="form_container">
								...
								<div class="input_wrap">
									...
									<input type="text" name="nationality" class="input" id="nationality" style="text-transform: capitalize;">
								</div>
								<div class="input_wrap">
									<label for="confirm_password">Religion</label>
									<input type="text" name="religion" class="input" id="religion" style="text-transform: capitalize;">
								</div>
								<div class="input_wrap">
								...
								<div class="input_wrap">
									...
									<input type="text" name="birthplace" class="input" id="birthplace" style="text-transform: capitalize;">
									<div class="error"></div>
						...
						<p>Please enter your infomation and proceed to the next step so we can process your identiication card.  </p>
							<div class="form_container">
								...
								<div class="input_wrap">
									...
									<input type="text" name="region" class="input" id="region" style="text-transform: capitalize;">
									<div class="error"></div>
								</div>
							</div>
						...
						<p>Please enter your infomation and proceed to the next step so we can process your identiication card.  </p>
							<div class="form_container">
								...
								<div class="input_wrap">
									...
									<label class="container1">N/A
										<input type="radio" name="occupation" id="occupation"  value="N/A" onclick="text(1)">
										<span class="checkmark1"></span>
									</label>

									<label class="container1">Managers
									<input type="radio" name="occupation" id="occupation" value="Managers" onclick="text(1)">
									<span class="checkmark1"></span>
									</label>
									
									<label class="container1">Professionals
									<input type="radio" name="occupation" id="occupation" value="Professionals" onclick="text(1)">
									<span class="checkmark1"></span>
									</label>
									
									<label class="container1"> Technicians and Associate Professionals
									<input type="radio" name="occupation" id="occupation" value="Technicians and Associate Professionals" onclick="text(1)"> 
									<span class="checkmark1"></span>
									</label>

									<label class="container1">Clerical Support Workers
									<input type="radio" name="occupation" id="occupation" value="Clerical Support Workers" onclick="text(1)">
									<span class="checkmark1"></span>
									</label>
									
									<label class="container1">Service and Sales Workers
									<input type="radio" name="occupation"  id="occupation" value="Service and Sales Workers" onclick="text(1)">
									<span class="checkmark1"></span>
									</label>
									
									<label class="container1"> Skilled Agricultural, Forestry and Fishery Workers
									<input type="radio" name="occupation"  id="occupation"  value="Skilled Agricultural, Forestry and Fishery Workers" onclick="text(1)"> 
									<span class="checkmark1"></span>
									</label>

									<label class="container1">Craft and Related Trade Workers
									<input type="radio" name="occupation" id="occupation" value="Craft and Related Trade Workers"  onclick="text(1)">
									<span class="checkmark1"></span>
									</label>
									
									<label class="container1">Plant and MAchine Operators and Assemblers
									<input type="radio" name="occupation" id="occupation"  value="Plant and MAchine Operators and Assemblers" onclick="text(1)">
									<span class="checkmark1"></span>
									</label>
									
									<label class="container1"> Elementary Occupations
									<input type="radio" name="occupation"  id="occupation" value="Elementary Occupations" onclick="text(1)"> 
									<span class="checkmark1"></span>
									</label>

									<label class="container1"> Armed Forces Occupation
									<input type="radio" name="occupation"  id="occupation" value="Armed Forces Occupation" onclick="text(1)"> 
									<span class="checkmark1"></span>
									</label>

									<label class="container1"> Others, specify
									<input type="radio" name="occupation" id="occupation"  value="thers, specify" onclick="text(0)"> 
									<span class="checkmark1"></span>
									</label>
