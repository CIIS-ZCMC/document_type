...
<body>
	<section>
		<div class="wrapper">
			...
			<form class="form" id="form" enctype="multipart/form-data" method="post" action="/updatebenefitapplication" >
				@csrf
				<div class="form_wrap">
				...
				<div class="btns_wrap">
                    {{-- @foreach($client->benefit_applications as  $clientcard) --}}
                        {{-- @if($clientcard->application_status == 'EVALUATION-DECLINED' or $clientcard->application_status == 'APPROVAL-DECLINED' or $clientcard->application_status == 'VERIFICATION-DECLINED') --}}
                                {{-- <div class="common_btns form_1_btns">
                                    <button type="submit"  class="btn_next">Search  <span class="icon"><ion-icon name="arrow-forward-sharp"></ion-icon></span></button>
                                </div>
                                     --}}
                        {{-- @else --}}
                            <div class="common_btns form_1_btns">
