...
<body>
	<section>
		<div class="wrapper">
			...
			<form class="form" id="form" enctype="multipart/form-data" method="post" action="/updatecardapplication" >
				@csrf
				<div class="form_wrap">
						...
						<p>Please enter your infomation and proceed to the next step so we can process your identiication card.  </p>
							<div class="form_container">
								...
								<div class="input_wrap">
									...
									<input type="hidden"  name="middlename" class="input"  style="text-transform: capitalize;" value="{{$client->middle_name}}" id="middlename" >
				...
				<div class="btns_wrap">
                    @foreach($client->client_applications as  $clientcard)
                        @if($clientcard->application_status == 'EVALUATION-DECLINED' or $clientcard->application_status == 'APPROVAL-DECLINED' or $clientcard->application_status == 'VERIFICATION-DECLINED')
                                <div class="common_btns form_1_btns">
                                    <button type="submit"  class="">Update  <span class="icon"><ion-icon name="arrow-forward-sharp"></ion-icon></span></button>
                                </div>
