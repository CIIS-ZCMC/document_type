...
<body>
	<section>
		<div class="wrapper">
			...
			<form class="form" id="form" enctype="multipart/form-data" method="post" action="/trackcardapplication" >
				@csrf
				<div class="form_wrap">
					<div class="form_1 data_info">
						...
						<p>Please enter your infomation and proceed to the next step so we can process your identiication card.  </p>
							<div class="form_container">
								...
								<div class="input_wrap">
									<label for="confirm_password">Application Refrence number</label>
