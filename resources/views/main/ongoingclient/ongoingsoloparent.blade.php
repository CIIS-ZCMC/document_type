			...
			<form class="form" id="form" enctype="multipart/form-data" method="post" action="/createregisteredsoloparent" >
						...
						<p>Please enter your infomation and proceed to the next step so we can process your identiication card.  </p>
							<div class="form_container">
								...
								<div class="input_wrap">
									...
									<input type="text"  name="idnumber" value="@foreach($client->client_applications as  $clientcard){{$clientcard->application_reference_number}}@endforeach" class="input" id="idnumber" id="email"  style="text-transform: capitalize;" >
									<i class="fas fa-check-circle"></i>
									<i class="fas fa-exclamation-circle"></i>
							...
							<div class="form_container">				
								...
								<div id="education">
									<div class="input_wrap" >
										...
										<input type="text" name="schoolname[]" class="input" id="schoolname" >
					...
					<div class="form_4 data_info" style="display: none;">
						...
						<div id="table_community">
							<div class="input_wrap" >
								...
								<input type="text" name="position[]" class="input" id="schoolname" >
				...
				<div class="btns_wrap">
					<div class="common_btns form_1_btns">
						<a href="/ongoingsoloparent" style="text-decoration: none;">
