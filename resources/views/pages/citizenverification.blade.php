...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">Verification List For Citizens</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">       
                            ...
                            @endphp --}}
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action w-56">
                                        ...
                                        <button href="javascript:;" class="btn btn-outline-primary w-32 mr-1 edit" data-tw-toggle="modal" data-tw-target="#evaluateclient">Verify</button>
      ...
      <div id="evaluateclient" class="modal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Verify Client</h2>
                </div>
                <form action="/verifycitizen" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                        ...
                        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                            ...
                            <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                                ...
                                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                                    <div id="firstname" name="firstname" class="truncate sm:whitespace-normal flex items-center"> <i data-lucide="mail" class="w-4 h-4 mr-2"></i>  </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 xl:col-span-6">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input id="civilstatus" name="civilstatus" type="text" class="form-control" placeholder="Input text" value="" disabled>
                                    </div>
                                    <div class="mt-3">
                    ...
                    <div class="intro-y box mt-5">
                        ...
                        <div class="modal-footer text-right">
                            ...
                            <button type="submit" id="capture" name="additem" class="btn btn-primary w-32">Verified</button>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" >
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinecitizenverification" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.edit', function()
        {
            ...
            $('#editform').attr('action','/verifycitizen/' + data[27]+'/'+data[28]);
            ...
            $('#declineform').attr('action','/declinecitizenverification/' + data[27]+'/'+data[28]);
