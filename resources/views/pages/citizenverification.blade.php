                ...
                <form action="/verifycitizen" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                        ...
                        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                            ...
                            <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
                                ...
                                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                                    <div id="firstname" name="firstname" class="truncate sm:whitespace-normal flex items-center"> <i data-lucide="mail" class="w-4 h-4 mr-2"></i> johnnydepp@left4code.com </div>
                    ...
                    <div class="intro-y box mt-5">
                        ...
                        <div class="modal-footer text-right">
                            ...
                            <button type="submit" id="capture" name="additem" class="btn btn-primary w-32">Verify</button>
