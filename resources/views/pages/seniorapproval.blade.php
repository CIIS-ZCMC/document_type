...
@section('subhead')
    <title>Senior Approval | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Approval List For Seniors</h2>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Approve Client</h2>
                </div>
                <form action="/approvecitizen" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                    @csrf
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declineseniorapproval" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
...
document.getElementById("schedule").setAttribute("min", today);
            ...
            $("#datatable").on('click', '.edit', function()
            {
                ...
                $('#editform').attr('action','/approveseniorcitizen/' + data[27]+'/'+data[28]);
                ...
                $('#declineform').attr('action','/declineseniorapproval/' + data[27]+'/'+data[28]);
            })
