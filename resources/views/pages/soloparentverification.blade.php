...
@section('subhead')
    <title>Solo Parent Verification | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Verification List For Solo Parents</h2>
                ...
                <form action="/evaluatecitizen" method="POST" method="POST" enctype="multipart/form-data" id="editform" name="editform" >
                    ...
                    <div class="intro-y box mt-5">
                        ...
                        <div class="modal-footer text-right">
                            ...
                            <button type="submit" id="addfo" name="additem" class="btn btn-primary w-32">Verified </button>
                        </div>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinesoloparentverification" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $("#datatable").on('click', '.edit', function()
            {
                ...
                $('#editform').attr('action','/verifysoloparent/' + data[27]+'/'+data[28]);
                ...
                $('#declineform').attr('action','/declinesoloparentverification/' + data[27]+'/'+data[28]);
