...
@section('subhead')
    <title>Declined Seniors | Social Welfare Registration and Benefits System</title>
@endsection
                    ...
                    @foreach($clients as $index => $client) 
                            ...
                            @endphp --}}
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>{{$client->declined_clients->date}}</td>
                                    <td>{{$client->declined_clients->decline_reason}}</td>
                                      <td id="filename"> 
