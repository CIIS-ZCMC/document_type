...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Approval List for Solo Parents</h2>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinesoloparentapprovalbenefit" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.edit', function()
        {
            ...
            $('#editform').attr('action','/approvesoloparentbenefit/' + data[27]+'/'+data[28]);
            ...
            $('#declineform').attr('action','/declinesoloparentapprovalbenefit/' + data[27]+'/'+data[28]);
