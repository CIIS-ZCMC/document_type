...
@section('subhead')
    <title>PWD Benefit Verification | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Verification List for PWDs</h2>
      ...
      <div id="evaluateclient" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                <div class="modal-header">Verify Benefit</h2>
                </div>
                <form action="/declinepwdverificationbenefit" method="POST" method="POST" enctype="multipart/form-data" id="editform" name="editform" >
                    @csrf
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.edit', function()
        {
            ...
            $('#editform').attr('action','/verifypwdbenefit/' + data[27]+'/'+data[28]);
            ...
            $('#declineform').attr('action','/declinepwdverificationbenefit/' + data[27]+'/'+data[28]);
