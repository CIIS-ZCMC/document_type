...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        ...
        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#new-fo-modal" class="btn btn-primary shadow-md mr-2">Add Personnel</a>
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
        <table id="datatable" class="table table-report -mt-2">
            ...
            <tbody>
                ...
                @foreach($personnel as $index => $personnels)    
                <tr class="intro-x">
                    <td id="foid">{{$index + 1}}</td>
                    <td id="foname">{{ $personnels->name}}</td>
                    <td>{{ $personnels->positions->name}}</td>
                   
                    <td  id="filename">{{ $personnels->id}}</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Add Personnel</h2>
                </div>
                <form action="/personnel/store" method="POST" enctype="multipart/form-data" >
                    @csrf
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                            <div class="col-span-12">
                                <label for="pos-form-1" class="form-label">Name</label>
                                <input id="document_name" name="name" type="text" class="form-control flex-1" placeholder="Name">
                            </div>
                            <div class="col-span-12">
                                <label for="pos-form-1" class="form-label">Position</label>
                               <select data-placeholder="Select Position" class="tom-select w-full" name="position_id">
