...
@section('subhead')
    <title>PWD Benefit Approval | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Approval List for PWDs </h2>
                    ...
                    @foreach($clients as $index => $client) 
                            ...
                            @endphp --}}
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td> @foreach($client->benefit_applicationss as  $clientapp)
                                      ...
                                      @endforeach</td>    
                                      <td id="filename"> 
                                        {{$client->benefit_applications_requirements[0]->filename}}
                                      </td>
                                      ...
                                      <td id="filename">{{$client->id}}
                                        ...
                                        <td  id="filename"> @foreach($client->benefit_applicationss as  $clientapp)
                                        {{$clientapp->id}}
                                        @endforeach</td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Approve Benefit</h2>
                </div>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinepwdapprovalbenefit" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.edit', function()
        {
            ...
            $('#editform').attr('action','/approvepwdbenefit/' + data[27]+'/'+data[28]);
            ...
            $('#declineform').attr('action','/declinepwdapprovalbenefit/' + data[27]+'/'+data[28]);
