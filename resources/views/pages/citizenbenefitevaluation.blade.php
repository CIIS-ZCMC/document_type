...
@section('subhead')
    <title>Citizen Benefit Evaluation | Social Welfare Registration and Benefits System</title>
@endsection
      ...
      <div id="evaluateclient" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                ...
                <form action="/evaluatecitizenbenefit" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                    @csrf
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinecitizenevaluationbenefit" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
