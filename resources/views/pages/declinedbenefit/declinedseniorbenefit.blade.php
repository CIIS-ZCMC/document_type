...
@section('subhead')
    <title>Declined Senior Benefit  | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">List of Declined Seniors</h2>
            ...
            <table id="datatable" class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th id="filename" class="whitespace-nowrap">declinetype</th>
                        <th id="filename" class="whitespace-nowrap">declinereason</th>
                            ...
                            @endphp --}}
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>{{$client->barangays->name}}
                                        <td>{{$client->decline_benefits->date}}</td>
                                        <td>{{$client->declined_benefits->decline_reason}}</td>
                                      <td id="filename"> 
                                        ...
                                        <td id="filename">{{$client->occupations->salary}}
                                            <td id="filename">{{$client->id}}
                                                    ...
                                                    <td  id="filename"> @foreach($client->client_applications as  $clientapp)
                                                      ...
                                                      <td id="filename">{{$client->declined_clients->decline_type}}
                                                        <td id="filename">{{$client->declined_clients->decline_reason}}
                    ...
                    <div class="intro-y box mt-5">
                        ...
                        <div class="p-5">
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 xl:col-span-6">
                                    <div >
                                        <label for="update-profile-form-6" class="form-label">Decline Type</label>
                                        <input id="declinetype" type="text" class="form-control"  value="" disabled>
                                    </div>
                                ...
                                <div class="col-span-12 xl:col-span-6">
                                    <div class="mt-3 xl:mt-0">
                                        <label for="religion" class="form-label">Decline Remarks</label>
                                        <input id="declinereason" type="text" class="form-control" placeholder="Input text" value="" disabled>
                                    </div>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinecitizen" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
    ...
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.edit', function()
        {
            ...
            //     = data[1];
                ...
                =  data[26];
                document.getElementById('declinetype').value
                =  data[29];
                document.getElementById('declinereason').value
                =  data[30];
               
            $('#editform').attr('action','/evaluateseniorcitizen/' + data[27]+'/'+data[28]);
            $('#declineform').attr('action','/declineseniorevaluation/' + data[27]+'/'+data[28]);
