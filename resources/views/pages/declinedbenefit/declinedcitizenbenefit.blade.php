...
@section('subhead')
    <title>Declined Citizen Benefit | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">List of Declined Citizens</h2>
