...
@section('subhead')
    <title>Declined PWD Benefit  | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">List of Declined PWD</h2>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>{{$client->barangays->name}}
                                      ...
                                      <td id="filename">{{$client->id}}
                                        ...
                                        <td id="filename">{{ $client->declined_clients->decline_type}}</td>  
                                        <td id="filename">{{ $client->declined_clients->decline_reason}}</td>  
