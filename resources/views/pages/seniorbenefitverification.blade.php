...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Verification List for Seniors</h2>
                                    ...
                                    <td> 
                                      ...
                                      <td id="filename">{{$client->occupations->employment_status}}</td>
                                        ...
                                        <td id="filename">{{$client->occupations->salary}}</td>
                                            <td id="filename">{{$client->id}}</td>
                                             
                                            <td  id="filename"> @foreach($client->benefit_applications as  $app)
                                                {{$app->id}}
                                              @endforeach
