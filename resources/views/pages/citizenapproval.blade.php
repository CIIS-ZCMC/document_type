...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">Approval List for Citizens</h2>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinecitizenapproval" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
...
document.getElementById("schedule").setAttribute("min", today);
        ...
        $(document).ready(function()
        {
            ...
            $("#datatable").on('click', '.edit', function()
            {
                ...
                $('#editform').attr('action','/approvecitizen/' + data[27]+'/'+data[28]);
                ...
                $('#declineform').attr('action','/declinecitizenapproval/' + data[27]+'/'+data[28]);
