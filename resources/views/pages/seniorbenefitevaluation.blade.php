...
@section('subhead')
    <title>Senior Benefit Evaluation | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Evaluation List for Seniors</h2>
                            ...
                            @endphp --}}
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td> 
                                      ...
                                      <td id="filename">{{$client->occupations->employment_status}}</td>
                                        <td id="filename">{{$client->occupations->employment_type}}</td>
                                        <td id="filename">{{$client->occupations->employment_category}}</td>
                                        <td id="filename">{{$client->occupations->occupation}}</td>
                                        <td id="filename">{{$client->occupations->salary}}</td>
                                        <td  id="filename"> @foreach($client->client_cards as  $card)
                                            {{$card->id}}
                                          @endforeach
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Evaluate Benefit</h2>
                </div>
                <form action="/evaluateseniorbenefit" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                    @csrf
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declineseniorevaluationbenefit" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.edit', function()
        {
            ...
            $('#editform').attr('action','/evaluateseniorbenefit/' + data[27]+'/'+data[28]+'/'+data[29]);
            $('#declineform').attr('action','/declineseniorevaluationbenefit/' + data[27]+'/'+data[28]);
