...
@section('subhead')
    <title>Solo Parent Benefit | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Evaluation List for Solo Parents</h2>
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinesoloparentevaluationbenefit" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function()
        {
            ...
            $("#datatable").on('click', '.edit', function()
            {
                ...
                $('#editform').attr('action','/evaluatesoloparentbenefit/' + data[27]+'/'+data[28]);
                ...
                $('#declineform').attr('action','/declinesoloparentevaluationbenefit/' + data[27]+'/'+data[28]);
