...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">List of Registered Seniors</h2>
                    ...
                    @foreach($clients as $index => $client) 
                            ...
                            @endphp --}}
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td> @foreach($client->client_cards as  $clientcard)
                                        {{$clientcard->card_number}}
                                      @endforeach</td>
                                      <td id="filename" > @foreach($client->client_cards as  $clientcard)
                                        {{$clientcard->card_status}}
                                      @endforeach</td>    
                                      <td id="filename"> 
                ...
                <form action="/evaluatecitizen" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                    ...
                    <div class="intro-y box mt-5">
                        ...
                        <div class="modal-footer text-right">
                            ...
                            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#next-overlapping-modal-preview" name="printid" id="printid" class="btn btn-primary">Print</a> 
                        </div>
                                            ...
                                            <div id="print">
                                                <div class="container1">
                                                    <div class="wrapper1">
                                                      ...
                                                      <div class="content1">
                                                        <img src="https://digitshack.com/codepen/mentor4/image-victor.jpg" alt="">
...
<script type="text/javascript">
    $(document).ready(function()
    {
            ...
            $("#printid").click(function()
				{
                    ...
                    = data[6] + data[8] + data[7] + data[9];
                    $('#idpic').attr("src","/images/picture/"+data[5]);
        ...
        $("#datatable").on('click', '.add', function()
        {
            ...
            $('#qrcode').attr("src","/images/qrcode/"+data[35]);
            $('#photo').attr("src","/images/picture/"+data[5]);
            $('#formid').attr('action','/email/completeid/' + data[32]);
