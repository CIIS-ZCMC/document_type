...
@section('subhead')
    <title>Solo Parent Card | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">List of Registered Solo Parent</h2>
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#datatable").on('click', '.add', function()
        {
            ...
            $('#qrcode').attr("src","/images/qrcode/"+data[54]);
            $('#photo').attr("src","/images/picture/"+data[5]);
            $('#formid').attr('action','/email/completeid/' + data[51]);
