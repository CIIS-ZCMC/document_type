...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">List of Registered Citizens</h2>
      ...
      {{-- <div id="evaluateclient" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                ...
                <form action="/generateqrcode" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                    @csrf
