...
@section('subhead')
    <title>Citizen Benefit Approval | Social Welfare Registration and Benefits System</title>
@endsection

@section('subcontent')

 
    <h2 class="intro-y text-lg font-medium mt-10">Benefits Approval List for Citizens</h2>
      ...
      <div id="evaluateclient" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content2">
                ...
                <form action="/approvecitizenbenefit" method="POST" method="POST" enctype="multipart/form-data" id="editform" >
                    @csrf
    ...
    <div id="next-overlapping-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <!-- END: Modal Header -->
                    <!-- BEGIN: Modal Body -->
                    <form action="/declinecitizenapprovalbenefit" method="POST" method="POST" enctype="multipart/form-data" id="declineform" >
                        @csrf
