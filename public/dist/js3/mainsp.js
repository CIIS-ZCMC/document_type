...
form_1_next_btn.addEventListener("click", function(){
	...
	if(firstnameValue === '' || lastnameValue === ''|| birthdateValue === '' || streetValue === '' || birthplaceValue === '' 
	|| cityValue === ''||provinceValue === ''|| regionValue === ''||mobilenumberValue === '' || emailaddressValue === ''
	|| civilstatus.value === '0' || gender.value==="0"|| education.value==="0" || barangay.value === '0') {
